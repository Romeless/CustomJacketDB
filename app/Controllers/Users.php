...
class Users extends ResourceController
{
    ...
    public function google_auth_mobile()
    {
      ...
      // Verify Token
      $id_token = $data['tokenID'];
      $client = new \Google_Client(['client_id' => "334821050843-q0853roui2istdq11erdeim0pbje9270.apps.googleusercontent.com"]);  // Specify the CLIENT_ID of the app that accesses the backend
      $payload = $client->verifyIdToken($id_token);
